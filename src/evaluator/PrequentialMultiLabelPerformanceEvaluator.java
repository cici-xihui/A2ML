...
public class PrequentialMultiLabelPerformanceEvaluator extends AbstractMOAObject implements MultiTargetPerformanceEvaluator {
    ...
    public Measurement[] getPerformanceMeasurements() {
        ...
        Measurement m[] = new Measurement[]{
                ...
                new Measurement("Hamming loss", sumHamming / b),
    ...
    public Measurement[] getMeasurements() {
        ...
        // Measurements
        Measurement m[] = new Measurement[]{
                new Measurement("Subset Accuracy", 0),
                new Measurement("Hamming loss", 0),
                new Measurement("Example-Based Accuracy", 0),
                new Measurement("Example-Based Precision", 0),
                new Measurement("Example-Based Recall", 0),
                new Measurement("Example-Based F-Measure", 0),
                new Measurement("Micro-Averaged Precision", 0),
                new Measurement("Micro-Averaged Recall", 0),
                new Measurement("Micro-Averaged F-Measure", 0),
                new Measurement("Macro-Averaged Precision", 0),
                new Measurement("Macro-Averaged Recall", 0),
                new Measurement("Macro-Averaged F-Measure", 0)
        };
